 ...
 **Prepare & Explore**
 ...
 The first step of our data exploration is to look at the scatterplots between viscosity and each parameters seperatly in order to determine wheter or not there is a relationship between our dependant variable and the independant variables.
...
blabla relevant values of our data:
```{r,echo=FALSE}
summary(icecream)
```

blabla mean of the viscosity: `r mean(icecream$viscosity)`
